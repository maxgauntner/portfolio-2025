  ...
  return (
    <Column maxWidth="m" gap="xl" horizontal="center">
      ...
      <Column fillWidth paddingY="24" gap="m">
        <Column maxWidth="s">
          {home.featured && (
          <RevealFx fillWidth horizontal="start" paddingTop="16" paddingBottom="32" paddingLeft="0" speed="fast">
          ...
          <RevealFx paddingTop="12" delay={0.4} horizontal="start" paddingLeft="0">
            <Button
              id="about"
              data-border="rounded"
              href={about.path}
