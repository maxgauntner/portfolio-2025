...
summary: "BEMO was in the midst of growing their business and conceptualizing a platform that could meet customer needs and demonstrate value."
images:
  - "/images/projects/compliance/hero.jpg"
  - "/images/projects/compliance/showcase.jpg"
team:
  - name: "Max Gauntner"
    role: "Product Design Consultant"
    avatar: "/images/avatar.jpg"
    linkedIn: "https://www.linkedin.com/in/maxgauntner/"
link: "https://share.vidyard.com/watch/kyyPkSjpy6735fq96vGrMT"
---
<Table
  data={{
    headers: [
    ...
    rows: [
      ["Max Gauntner", "Product Design Consultant"],
      ["Craig Knowles", "Director of Product and Development"],
      ["Natalie See", "Product Manager"],
      ["Alejandro Pons", "Senior Software Engineer"],
      ["Molnar Ivan", "Software Engineer"],
    ],
  }}
/>
...
<AccordionGroup marginTop="20" marginBottom="20"
  items={[
    ...
    },
    {
      ...
      content:
        <Text onBackground="neutral-medium" variant="body-default-l">
          For team communication as project work was virtual.
        </Text>
    },
    {
      title: "Miro",
...
<div className="display-flex pb-4 g-m s-flex-column s-flex min-width-0 fill-width">
    <div className="display-flex flex-6">![Example](/images/projects/compliance/tool-1.jpg)</div>
    <div className="display-flex flex-6">![Example](/images/projects/compliance/tool-2.jpg)</div>
</div>
...
![Example](/images/projects/compliance/showcase.jpg)
...
![Example](/images/projects/compliance/feature-1.jpg)
...
![Example](/images/projects/compliance/feature-2.jpg)
...
![Example](/images/projects/compliance/feature-3.jpg)
...
![Example](/images/projects/compliance/feature-4.jpg)
